							...
							<div class="content">
								<table class="grid">
									...
									<tbody>
										<tr>
											<td>
												<strong data-toggle="modal" data-target="#looker">Bee, Evan</strong>
											</td>
											<td class="center">4</td>
										</tr>
										<tr>
											<td>
												<strong data-toggle="modal" data-target="#looker">Doe, Tom</strong>
											</td>
											<td class="center">2</td>
										</tr>
										<tr>
											<td>
												<strong data-toggle="modal" data-target="#looker">Gall, Shelly</strong>
											</td>
											<td class="center">5</td>
										</tr>
										<tr>
											<td>
												<strong data-toggle="modal" data-target="#looker">Moore, Lizzy</strong>
											</td>
											<td class="center">3</td>
										</tr>
										<tr>
											<td>
												<strong data-toggle="modal" data-target="#looker">Nomero, Sean</strong>
											</td>
											<td class="center">2</td>
										</tr>
										<tr>
											<td>
												<strong data-toggle="modal" data-target="#looker">Lee, Opal</strong>
											</td>
											<td class="center">1</td>
										</tr>
									</tbody>
